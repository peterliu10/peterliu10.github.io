...
function Single_trailLoopBegin(Single_trailLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisSingle_trail of Single_trail) {
...
function Game_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Game_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Rank1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Rank1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Message_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Message_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Wait_PunishRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Wait_PunishComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function PunishRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PunishComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Blank_trailRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Blank_trailComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
